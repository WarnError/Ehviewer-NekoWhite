...
public class AdvanceSearchTable extends LinearLayout {
    ...
    public static final int SDT = 0x2;
    public static final int STO = 0x4;
    ...
    public void init(Context context) {
        ...
        mSdt = (CheckBox) row0.getChildAt(1);

        ViewGroup row1 = (ViewGroup) getChildAt(1);
        mSto = (CheckBox) row1.getChildAt(0);

        ViewGroup row2 = (ViewGroup) getChildAt(2);
        mSr = (CheckBox) row2.getChildAt(0);
        mMinRating = (Spinner) row2.getChildAt(1);

        ViewGroup row3 = (ViewGroup) getChildAt(3);
        mSp = (CheckBox) row3.getChildAt(0);
        mSpf = (EditText) row3.getChildAt(1);
        mSpt = (EditText) row3.getChildAt(3);

        ViewGroup row5 = (ViewGroup) getChildAt(5);
        mSfl = (CheckBox) row5.getChildAt(0);
        mSfu = (CheckBox) row5.getChildAt(1);
        mSft = (CheckBox) row5.getChildAt(2);
    ...
    public int getAdvanceSearch() {
        ...
        if (mSdt.isChecked()) advanceSearch |= SDT;
    ...
    public void setAdvanceSearch(int advanceSearch) {
        ...
        mSdt.setChecked(NumberUtils.int2boolean(advanceSearch & SDT));
